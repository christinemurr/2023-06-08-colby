...
venue: "Colby College"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
instructor: ["Pete Schlax", "Christine Murray"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
